            ...
            <div class="row row-bottom-padded-sm">
                <div class="col-md-4 col-sm-6 col-xxs-12">
                    <a href="images/work_1.jpg" class="fh5co-project-item image-popup to-animate">
                        <img src="{{asset('images/work_1.jpg')}}" alt="Image" class="img-responsive">
                        <div class="fh5co-text">
                        <h2>Project 1</h2>
                        <span>Branding</span>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xxs-12">
                    <a href="{{asset('images/work_2.jpg')}}" class="fh5co-project-item image-popup to-animate">
                        <img src="{{asset('images/work_2.jpg')}}" alt="Image" class="img-responsive">
                        <div class="fh5co-text">
                        <h2>Project 2</h2>
                        <span>Web</span>
                        </div>
